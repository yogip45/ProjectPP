...
@include('/dashboard/tambahmenu')
                    ...
                    <br>
                    <p></p>
                    <form class="forms-sample" method="POST" action="/edituser/{{ $data->id }}" enctype="multipart/form-data">
                      @csrf
                      <div class="form-group">
                        <label for="exampleInputUsername1">Nama Pengguna</label>
                        <input type="text" class="form-control" id="nama_pengguna" placeholder="nama" name="name" value="{{ $data->name }}">
                      </div>
                      <div class="form-group">
