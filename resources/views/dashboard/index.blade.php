...
<head>
  ...
  <!-- End layout styles -->
  <link rel="shortcut icon" href={{ asset("assets/images/LOGO BOSS.png") }} />
</head>
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <div class="nav-profile-text">
                <p class="mb-1 text-black"><span>{{ Session::get('email') }}</span></p>
              </div>
            </a>
            <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
              ...
              <div class="p-2">
                ...
                <a class="dropdown-item py-1 d-flex align-items-center justify-content-between" href="/sesi/logout">
                  <span>Log Out</span>
                ...
                <div class="tab-pane fade show active" id="business-1" role="tabpanel" aria-labelledby="business-tab">
                  <div class="row">
                    <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body text-center">
                          ...
                          <h2 class="mb-4 text-dark font-weight-bold">{{ $jumlahmenu }}</h2>
                          <div class="dashboard-progress dashboard-progress-1 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-food icon-md absolute-center text-dark"></i></div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body text-center">
                          <h5 class="mb-2 text-dark font-weight-normal">Pesanan</h5>
                          <h2 class="mb-4 text-dark font-weight-bold">{{ $jumlahorder }}</h2>
                          <div class="dashboard-progress dashboard-progress-2 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-cube icon-md absolute-center text-dark"></i></div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body text-center">
                          ...
                          <h2 class="mb-4 text-dark font-weight-bold">{{ $jumlahuser }}</h2>
                          <div class="dashboard-progress dashboard-progress-3 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-account-key icon-md absolute-center text-dark"></i></div>
                          {{-- <p class="mt-4 mb-0">Increased since yesterday</p>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body text-center">
                          <h5 class="mb-2 text-dark font-weight-normal">Pengunjung</h5>
                          <h2 class="mb-4 text-dark font-weight-bold">5</h2>
                          <div class="dashboard-progress dashboard-progress-4 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-cube icon-md absolute-center text-dark"></i></div>
                          <p class="mt-4 mb-0">Pengunjung</p>
